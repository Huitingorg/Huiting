...
namespace BDSoft.Common
{
	...
	public abstract class TabStyleProvider : Component
	{
		...
		protected TabStyleProvider(TabControlEx2 tabControl){
		...
		public static TabStyleProvider CreateProvider(TabControlEx2 tabControl){
		...
		protected TabControlEx2 _TabControl;
