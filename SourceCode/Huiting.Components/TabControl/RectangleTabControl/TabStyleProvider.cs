...
namespace Huiting.Components
{
	...
	public abstract class TabStyleProvider : Component
	{
		...
		protected TabStyleProvider(RectangleTabControl tabControl){
		...
		public static TabStyleProvider CreateProvider(RectangleTabControl tabControl){
		...
		protected RectangleTabControl _TabControl;
