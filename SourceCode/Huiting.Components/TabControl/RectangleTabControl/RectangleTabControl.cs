...
namespace Huiting.Components
{
    ...
    public class RectangleTabControl : TabControl
    {
        ...
        private DateTime SelectDateTime = DateTime.Now;
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
                ...
                && this.GetTabImageRect(index).Contains(this.MousePosition))
            {
                ...
                if (DateTime.Now.Subtract(SelectDateTime).Milliseconds > 200)
                {
        ...
        private void CustomPaint(Graphics screenGraphics)
        {
            ...
            if (this.Width > 0 && this.Height > 0)
            {
                ...
                //_BackBuffer.Save(@"E:\cmp\3.bmp");

                //Bitmap bmp1 = new Bitmap(this.Width, this.Height);
                //screenGraphics.DrawImage(bmp1, new Point(0, 0));
                //bmp1.Save(@"E:\cmp\1.bmp");

                //Bitmap bmp2 = new Bitmap(this.Width, this.Height);
                //_BackBuffer.DrawImage(bmp2, new Point(0, 0));
                //bmp2.Save(@"E:\cmp\1.bmp");
            }
        }
